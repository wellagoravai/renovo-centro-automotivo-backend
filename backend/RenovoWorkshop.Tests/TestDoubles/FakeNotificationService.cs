...
public class FakeNotificationService : INotificationService
{
    ...
    public int CustomerRegistrationNotificationsSent { get; private set; }
    ...
    public Task NotifyCustomerRegistrationAsync(Guid customerId, string customerName, Guid serviceOrderId, string orderNumber, CancellationToken cancellationToken = default)
    {
        CustomerRegistrationNotificationsSent++;
        return Task.CompletedTask;
    }
}
