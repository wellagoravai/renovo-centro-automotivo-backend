...
export const SOCIAL_MEDIA_LINKS = {
    facebook: 'https://facebook.com/renovocentroautomotivo',
    instagram: 'https://www.instagram.com/renovo_centro_automotivo/',
    twitter: 'https://twitter.com/renovocentroautomotivo',
};
